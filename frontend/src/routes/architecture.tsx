...
function ArchitecturePage() {
  return <div className="space-y-6">
    ...
    <div className="grid gap-4 md:grid-cols-2">
      ...
      <Card className="compactable gap-2 p-5"><h2 className="font-bold">Image</h2><p className="text-sm text-muted-foreground">FastAPI → CLIP political-content gate → experimental zero-shot whole-scene emotion scores.</p></Card>
