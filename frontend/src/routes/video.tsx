...
export const Route = createFileRoute("/video")({ component: VideoAnalysisPage });
...
function VideoAnalysisPage() {
  ...
  return <div className="space-y-6">
    <PageHeader eyebrow="Video analysis" title="Political Video Emotion Analysis" description="Upload a political video for temporal emotion analysis." />
    <Card className="compactable gap-5 p-6">
      <UploadZone modality="video" file={file} onSelect={select} onClear={clear} />
      ...
      <div className="flex gap-2"><Button disabled className="gap-1.5"><Video className="h-4 w-4" />Analyze Video</Button><Button variant="outline" onClick={clear} disabled={!file}>Clear</Button></div>
    </Card>
  </div>;
}
